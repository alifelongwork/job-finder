...
employers run iCIMS, SuccessFactors, Oracle Cloud, or Workday rather than Greenhouse/Lever —
so expect the ATS Cookbook's Workday CXS path and branded-careers-page verification more than
